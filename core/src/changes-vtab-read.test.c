...
static void testChangesUnionQuery() {
  ...
  assert(
      strcmp(
          ...
          "__crsql_siteid as t3 ON t1.__crsql_site_id = t3.ordinal UNION ALL "
          "SELECT\n"
          "          'bar' as tbl,\n"
          ...
          "__crsql_siteid as t3 ON t1.__crsql_site_id = t3.ordinal) ") == 0);
  sqlite3_free(query);
  ...
  assert(strcmp(query,
                ...
                "JOIN __crsql_siteid as t3 ON t1.__crsql_site_id = t3.ordinal "
                "UNION ALL SELECT\n"
                "          'bar' as tbl,\n"
                "          crsql_pack_columns(t1.\"x\") as pks,\n"
                "          t1.__crsql_col_name as cid,\n"
